...
class LocationsViewController: UIViewController, UITableViewDelegate,LocationsViewControllerDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    @IBOutlet weak var searchBar: UISearchBar!
     weak var delegate_locationsPickedLocation : LocationsViewControllerDelegate!
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate_locationsPickedLocation.locationsPickedLocation(controller: self, latitude: lat, longitude: lng)
